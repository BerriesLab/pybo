...
# class MCMultiOutputBase(MCMultiOutputObjective, MCBase, ABC):
#     def __init__(
#             self,
#             device: torch.device,
#             dtype: torch.dtype,
...
#             obj_to_minimize=obj_to_minimize,
#             bounds=bounds,
#             ref_point=ref_point,
#             outcomes=outcomes,
...
#             max_hv=max_hv,
#             linear_equality_input_constraints=linear_equality_input_constraints,
#             linear_inequality_input_constraints=linear_inequality_input_constraints,
#             nonlinear_inequality_input_constraints=nonlinear_inequality_input_constraints,
...
#     @num_objectives.setter
#     def num_objectives(self, num_objectives: int):
#         if not isinstance(num_objectives, int) or not num_objectives >= 2:
#             raise ValueError("'num_objectives' must be an integer >= 2")
#         self._num_objectives = num_objectives
#
#
# class MCSingleOutputBase(MCAcquisitionObjective, MCBase, ABC):
#     def __init__(
#             self,
#             device: torch.device,
#             dtype: torch.dtype,
...
#     @num_objectives.setter
#     def num_objectives(self, num_objectives: int):
#         if not isinstance(num_objectives, int) or not num_objectives == 1:
...
#             value = value.tolist()
#         else:
#             raise TypeError("outcomes must be None, a list of ints or a torch.Tensor")
#
#         if len(value) < 2:
#             raise BotorchTensorDimensionError(
#                 "Must specify at least two outcomes for MOBO."
#             )
#         if any(i < 0 for i in value):
#             if self.num_outcomes is None:
#                 raise BotorchError(
...
#
# class MCBase(MCAcquisitionObjective, ABC):
#     """
#     Base class for Monte Carlo single-output objectives.
#     """
#
#     def __init__(
#             self,
...
#             raise TypeError("negate must be a list of bools or a torch.Tensor")
#         if value.size(0) != 1:
#             raise ValueError("'obj_to_minimize' must have exactly one element")
#         self._obj_to_minimize = value
#
#     @property
#     def ref_point(self) -> Tensor:
...
#     def outcomes(self, value: list[int] | torch.Tensor | None):
#         """
#         Index of model output used as objective. If None, use index 0 as objective.
#         """
#         if value is None:
#             self._outcomes = None
#             return
...
#         if len(value) < 1:
#             raise BotorchTensorDimensionError(
#                 "Must specify at least one outcome for BO."
#             )
#         if any(i < 0 for i in value):
#             if self.num_outcomes is None:
#                 raise BotorchError(
