...
from tutorials.multi_objective.iformac.unconstrained.objective import IFormAC
...
if __name__ == "__main__":
    args = parse_trial_args(description="Run a single unconstrained IFormAC BO trial.")
