...
from objectives.single_objective.wave_packet import WavePacketTestFunction
...
def main(n_samples=64, q: int = 1, ):
    ...
    mobo = BayesianOptimizer(
        ...
        dtype=DTYPE,
        objective=objective,
        acquisition_function_builder=AcquisitionFunctionType.EI,
        kernel_builder=KernelType.RBF_TIMES_PERIODIC,
        X=X,
        Y_obj=Y_obj,
        Y_obj_var=None,
        Y_con=None,
