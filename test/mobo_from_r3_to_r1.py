...
""" Inputs """
n_objectives = 1
f0: list[callable] = [test_f0_3d]
n_samples: int = 20  # Number of initial samples
bounds: list[tuple[float, float]] = [(-5, 5), (-5, 5), (-5, 5)]  # Domain bounds
n: list[int] = [100, 100, 100]
header: str = "x1,x2,x3,y1"  # Dynamic header for objectives
...
for i in range(n_samples, n_samples + n_experiments):
    ...
    if i == n_samples:
        ...
        mobo = Mobo(
            ...
            experiment_name="test_mobo_from_R3_to_R1",
            bounds=bounds,
