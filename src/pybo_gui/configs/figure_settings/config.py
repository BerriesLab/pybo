...
style`` (configs/figure_settings/store.py), derives per-plot figsize and scales line
widths, and pushes the resolved ``rcparams`` into matplotlib. Plotters import this module
at subprocess startup and read ``fig_cfg`` (and ``scale_figsize``).
"""
import copy

from pybo_gui.configs.figure_settings.store import (
