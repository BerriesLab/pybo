...
from bayesian_optimization.test.objective_functions import test_f0_3d
...
numpy.savetxt("../../data/3d_dataset.csv", samples, delimiter=",", header="x1,x2,x3,y", comments="")

""" Run experiments and collect data - Simulation"""
X = numpy.loadtxt("../../data/3d_dataset.csv", delimiter=",", skiprows=1)
...
for i in range(2):
    ...
    new_y = test_f0_3d(new_x.reshape(1, -1))
