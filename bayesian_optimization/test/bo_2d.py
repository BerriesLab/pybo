...
X_init = np.array([[-4, -8], [-2, -4], [0, 0], [2, 2], [4, 6], [-4, 6], [4, -6]])
Y_init = test_f0_2d(X_init)
# TODO: add grid sampling and LHS
bounds = [(-5, 5), (-10, 10)]
opt.set_initial_dataset(X_init, Y_init)
opt.set_bounds(bounds)
...
opt.set_number_of_objective_function_calls(100)
